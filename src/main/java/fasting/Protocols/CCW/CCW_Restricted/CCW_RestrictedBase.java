...
//%% NEW FILE CCW_RestrictedBase BEGINS HERE %%
...
// line 3 "model.ump"
// line 179 "model.ump"
public class CCW_RestrictedBase
{
  ...
  //CCW_RestrictedBase State Machines
  ...
  {
    private CCW_RestrictedBase controller;
    private String timeoutMethodName;
    private double howLongInSeconds;
    private Timer timer;

    public TimedEventHandler(CCW_RestrictedBase aController, String aTimeoutMethodName, double aHowLongInSeconds)
    {
