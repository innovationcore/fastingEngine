...
//%% NEW FILE CCW_BaselineBase BEGINS HERE %%
...
public class CCW_BaselineBase
{
  ...
  private boolean __autotransition522__()
  {
    boolean wasEventProcessed = false;
  ...
  private boolean __autotransition523__()
  {
    boolean wasEventProcessed = false;
  ...
  {
    private CCW_BaselineBase controller;
    private String timeoutMethodName;
    private double howLongInSeconds;
    private Timer timer;

    public TimedEventHandler(CCW_BaselineBase aController, String aTimeoutMethodName, double aHowLongInSeconds)
    {
